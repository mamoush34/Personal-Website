...
export const databaseDesc: string = "In this project, you are able to create a simple server to manage a database of key-value pairs over a network. Multiple concurrent users are able to search for items in the database, add new entries, and remove existing entries, all while using proper lock usage to ensure no data race happens.";
